...
<div class="mt-6 hidden lg:flex items-center pb-4">
	<button
		...
		on:click={() => switchMode('grid')}>Grid View</button
	>
	<span class="px-2">/</span>
	<button
		class="px-3 py-2 hover:bg-neutral-200 dark:hover:bg-dark-700 rounded-lg"
		class:font-extrabold={!gridMode}
		on:click={() => switchMode('list')}>List View</button
	>
</div>
			...
			<div class="mt-4 sm:mt-0">
				...
				>
					...
					>
						...
						>
							<img
								class="object-cover w-full h-48 group-hover:rotate-3 group-hover:scale-110 transition-all duration-1000"
		...
		>
			<div class="p-2 bg-neutral-100 dark:bg-dark-700 rounded-lg">
				{#each data.projects as project}
					<div class="w-full">
						<a
							class="px-3 py-1 block rounded-md hover:bg-neutral-200 dark:hover:bg-dark-600 leading-10"
